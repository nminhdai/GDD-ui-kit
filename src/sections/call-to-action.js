      ...
      <Container>
        <Flex sx={styles.flex}>
          <Box sx={styles.content}>
            <Text as="span">Go along with GDD</Text>
            <Heading as="h3">
              Beyond the worldwide with our fascinating services
            </Heading>
            <Text as="p">
              We offer our services in various locations around the world, in
              addition to Japan. We have more locations in the US and Southeast
              Africa where people are in great need of beauty
            </Text>
